# gh repo — Repositories (and gh browse)

Repo lifecycle commands: create, clone, list, view, edit, delete, fork, sync, set-default, autolinks, deploy-keys, gitignore/license. Plus `gh browse` to open repo URLs.
Loaded when user works with repository management.
