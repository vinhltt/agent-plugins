...
Actions ecosystem: workflow runs (list/view/watch/rerun/cancel/download), workflow management (list/view/run/enable/disable), action caches (list/delete).
For secrets/variables see `secrets.md`.
Loaded when user works with Actions automation.
