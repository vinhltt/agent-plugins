# gh extras — Other commands and cross-cutting reference

Less-frequent commands plus cross-cutting topics (CLI structure, configuration, environment).
...
## CLI Structure (full command tree)
...
## Configuration (gh config + env vars)
