...
PR commands: create, list, view, checkout, diff, merge, close/reopen, edit, ready, checks, comment, review, update-branch, lock/unlock, revert, status.
Loaded when user works with `gh pr`.
