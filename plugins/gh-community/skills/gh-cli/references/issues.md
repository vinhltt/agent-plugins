...
Issue commands: create, list, view, edit, close/reopen, comment, status, pin/unpin, lock/unlock, transfer, delete, develop (draft PR from issue).
Loaded when user works with `gh issue`.
