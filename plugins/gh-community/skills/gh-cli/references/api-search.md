# gh api / gh search — Raw API and Search

`gh api` for raw REST/GraphQL access with auth + pagination. `gh search` for code/repos/issues/prs/commits across GitHub.
Loaded when user needs custom API calls or cross-repo search.
