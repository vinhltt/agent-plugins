// TODO(sync): ported from .claude/skills/skill-bump/tests/git-helpers.test.ts
// Port date: 2026-05-09. Adjust import paths only; keep test logic identical.
// Divergence: assertTargetSafe checks SKILL.md (kept as-is — function still present in port).
