...
- Prefix with component name when a skill/agent/command/hook is added or changed (NO version number — versions are tracked in component frontmatter)
- ❌ Bad: `Add xlsx-to-csv skill v0.1.0: converts XLSX to CSV`
- ✅ Good: `xlsx-to-csv: add skill with auto-detect and multi-sheet support`
